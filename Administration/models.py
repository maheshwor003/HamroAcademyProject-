...
class Sections(models.Model):
    ...
    meeting_time = models.ForeignKey(
        MeetingTimes, on_delete=models.CASCADE, blank=True, null=True)
    room = models.ForeignKey(
        Rooms, on_delete=models.CASCADE, blank=True, null=True)
    instructor = models.ForeignKey(
        Instructors, on_delete=models.CASCADE, blank=True, null=True)

    def set_room(self, room):
        section = Sections.objects.get(pk=self.section_id)
        section.room = room
        section.save()
