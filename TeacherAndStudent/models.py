...
class Class(models.Model):
    ...
    def __str__(self):
        d = Departments.objects.get(name=self.dept)
...
class Assign(models.Model):
    ...
    def __str__(self):
        ...
        cr = Courses.objects.get(id=self.course_id)
...
class Attendance(models.Model):
    ...
    def __str__(self):
        ...
        cname = Courses.objects.get(name=self.course)
...
class AttendanceTotal(models.Model):
    ...
    def att_class(self):
        ...
        cr = Courses.objects.get(name=self.course)
